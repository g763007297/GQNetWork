...
typedef enum : NSUInteger{
    GQDataCacheNone,
    GQDataCacheUserDefault,
    GQDataCacheFile
} GQDataCacheType;

@interface GQDataCacheManager : NSObject

@property (nonatomic, assign) GQDataCacheType dataCacheType;

+ (GQDataCacheManager *)sharedManager;
